...
public class MatrixTester {
		...
		{			
			...
			Matrix computedTransposed = M1.transpose();
			Matrix referenceTransposed = new Matrix(new int[][]
                    {{1,4},
					  {2 ,5 },
                    { 3,6  }});
			System.out.println("M1 Transposed: " + computedTransposed); 
			if(!referenceTransposed.equals(computedTransposed)) 
				System.out.println("Your multiplication is wrong. Should be:\n" + referenceTransposed);
