...
public class Library<Type> {
  ...
  protected class IsbnComparator implements Comparator<LibraryBook<Type>> {
	  public int compare(LibraryBook<Type> leftBook, LibraryBook<Type> rightBook) {
		  
		  //returns  0  if left = right
		  if (leftBook.getIsbn() == rightBook.getIsbn()) {
			  return 0;
		  }
		  //returns >0  if left > right
		  else if(leftBook.getIsbn() > rightBook.getIsbn()){
			  return 1;
		  }
		  //returns <0  if left < right
		  else {
  ...
  public ArrayList<LibraryBook<Type>> getOverdueList(int month, int day, int year) {
	  ...
	  ArrayList<LibraryBook<Type>> copy = new ArrayList<LibraryBook<Type>>();  
	  GregorianCalendar dueCheck = new GregorianCalendar(day, month, year);
 ...
 /**
  ...
  protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	  ...
	  public int compare(LibraryBook<Type> leftBook, LibraryBook<Type> rightBook) {
		  ...
		  if(leftBook.getAuthor().compareTo(rightBook.getAuthor()) == 0) {
			  if(leftBook.getTitle().compareTo(rightBook.getTitle()) > 0 ) {
				  return 1;
		  ...
		  }else if(leftBook.getAuthor().compareTo(rightBook.getAuthor()) > 0){
			  return 1;
		  }
		  else {
			  return -1; 
