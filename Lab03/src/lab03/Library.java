...
public class Library {
  ...
  public ArrayList<LibraryBook> lookup(String holder) {
	  //setting holderBooks as an arrayList so books can be added to it.
	  ArrayList<LibraryBook> holdersBooks = new ArrayList<LibraryBook>();
	  //Looping through all books owned by library to see if there is a book that the holder has
	  for(LibraryBook book : library) {
  ...
  public boolean checkin(long isbn) {
	  for(LibraryBook book : library) {
		  if(book.getIsbn() == isbn) {
			  if((book.getDueDate()== null) && (book.getHolder() == null)  ) {
				  return false;
			  }else {
				  book.checkin();
				  return true;
  ...
  public boolean checkin(String holder) {
	  boolean atLeastOneBookInLibrary = false; 
	  for(LibraryBook book : library) {
		  if(book.getHolder() == holder) {
			  book.checkin();
			  atLeastOneBookInLibrary = true;
	  ...
	  return atLeastOneBookInLibrary;
  }
}